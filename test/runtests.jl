...
facts("Testing Render Outputs") do
    ...
    context("Testing geometry tags") do
        @fact box(10.0, 11.0, 12.0) -->
            Elem(:"three-js-box", w = 10.0, h = 11.0, d = 12.0)
        @fact sphere(10.0) -->
            Elem(:"three-js-sphere", r = 10.0)
        @fact pyramid(10.0, 12.0) -->
            Elem(:"three-js-pyramid", base = 10.0, height = 12.0)
        @fact cylinder(10.0, 11.0, 12.0) -->
            Elem(:"three-js-cylinder", top = 10.0, bottom = 11.0, height = 12.0)
        @fact torus(12.0, 2.0) -->
            Elem(:"three-js-torus", r = 12.0, tube = 2.0)
        @fact parametric(2, 3, 0:2, 0:3, (x, y) -> x + y) -->
            Elem(:"three-js-parametric", slices = 2, stacks = 3) <<
                [
                    Elem(:"three-js-vertex", x = 0.0, z = 0.0, y = 0.0),
                    Elem(:"three-js-vertex", x = 1.0, z = 0.0, y = 1.0),
                    Elem(:"three-js-vertex", x = 2.0, z = 0.0, y = 2.0),
                    Elem(:"three-js-vertex", x = 0.0, z = 1.0, y = 1.0),
                    Elem(:"three-js-vertex", x = 1.0, z = 1.0, y = 2.0),
                    Elem(:"three-js-vertex", x = 2.0, z = 1.0, y = 3.0),
                    Elem(:"three-js-vertex", x = 0.0, z = 2.0, y = 2.0),
                    Elem(:"three-js-vertex", x = 1.0, z = 2.0, y = 3.0),
                    Elem(:"three-js-vertex", x = 2.0, z = 2.0, y = 4.0),
                    Elem(:"three-js-vertex", x = 0.0, z = 3.0, y = 3.0),
                    Elem(:"three-js-vertex", x = 1.0, z = 3.0, y = 4.0),
                    Elem(:"three-js-vertex", x = 2.0, z = 3.0, y = 5.0),
                ]
        @fact meshlines(2, 3, 0:2, 0:3, (x, y) -> x + y) -->
            Elem(:"three-js-meshlines", slices = 2, stacks = 3) <<
                [
                    Elem(:"three-js-vertex", x = 0.0, z = 0.0, y = 0.0),
                    Elem(:"three-js-vertex", x = 1.0, z = 0.0, y = 1.0),
                    Elem(:"three-js-vertex", x = 2.0, z = 0.0, y = 2.0),
    ...
    context("Testing vertex") do
        @fact vertex(2.0, 3.0, 4.0) -->
            Elem(:"three-js-vertex", x = 2.0, y = 3.0, z = 4.0)
    end
